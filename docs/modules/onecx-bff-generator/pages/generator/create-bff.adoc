...
|`--autobuild`
|Builds the application after generation. If you want to build it manually, you can omit this flag and run `mvn clean package` in the generated directory.

|`--name`
|Specifies the name of the generated BFF. The value is used as the base for the project name, artifact name and essential application parts.

|`--group`
|Specifies the Maven `groupId` of the generated BFF project.

|`--package`
|Specifies the base Java package name of the generated BFF project.
...
|`--artifact-id`
|Specifies a custom Maven `artifactId`. If omitted, the artifact ID is derived from the project name.

|`--output-dir`
|Specifies a custom output directory for the generated project.
